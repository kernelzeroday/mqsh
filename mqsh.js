...
(function() {
  var Corporal, argv, base64_encode, base64str, basesixfourdecode, basesixfourencode, btchost, btcport, btcpw, btcrpc, btcuser, client, colors, corporal, decryptkey, defenc, escapeJSON, exec, fs, jsesc, mqpasswd, mqtt, mquser, pjs, prettyjson, pubtopic, readcommand, rpcpassword, rpcuser, servername, shell, simpleout, startinteractive, subtopic;
