...
(function() {
  var Corporal, aexec, argv, base64_encode, base64str, basesixfourdecode, basesixfourencode, btchost, btcport, btcpw, btcrpc, btcuser, client, colors, corporal, decryptkey, defenc, fs, mqpasswd, mqtt, mquser, pubtopic, readcommand, rpcpassword, rpcuser, servername, shell, startinteractive, subtopic;
  ...
  shell = function() {
    ...
    client.on('message', function(topic, message) {
      ...
      if (defenc === 1) {
        ...
        fs.writeFile("/tmp/messagebuffer", epacket, function(err) {
          if (err) {
            console.log(err);
          }
